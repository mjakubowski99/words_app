...
class FlashcardDeckController
{
    ...
    #[OAT\Get(
        path: '/api/v2/flashcards/decks/by-admins',
        operationId: 'v2.flashcards.decks.by-admins.index',
        description: 'Get decks generated by admin',
        summary: 'Get flashcard decks provided by administrators',
        security: [['sanctum' => []]],
        tags: [Tags::V2, Tags::FLASHCARD],
        parameters: [
            new OAT\Parameter(
