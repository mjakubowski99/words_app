    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Flashcard\Application\Repository\IFlashcardDeckReadRepository' => \Flashcard\Infrastructure\Repositories\Postgres\FlashcardDeckReadRepository::class,
            'Flashcard\Application\Repository\IFlashcardDeckRepository' => \Flashcard\Infrastructure\Repositories\Postgres\FlashcardDeckRepository::class,
            'Flashcard\Application\Repository\IFlashcardDuplicateRepository' => \Flashcard\Infrastructure\Repositories\Postgres\FlashcardDuplicateRepository::class,
            'Flashcard\Application\Repository\IFlashcardReadRepository' => \Flashcard\Infrastructure\Repositories\Postgres\FlashcardReadRepository::class,
            'Flashcard\Application\Repository\IFlashcardRepository' => \Flashcard\Infrastructure\Repositories\Postgres\FlashcardRepository::class,
            'Flashcard\Application\Repository\INextSessionFlashcardsRepository' => \Flashcard\Infrastructure\Repositories\Postgres\NextSessionFlashcardsRepository::class,
            'Flashcard\Application\Repository\IRateableSessionFlashcardsRepository' => \Flashcard\Infrastructure\Repositories\Postgres\RateableSessionFlashcardsRepository::class,
            'Flashcard\Application\Repository\ISessionFlashcardReadRepository' => \Flashcard\Infrastructure\Repositories\Postgres\SessionFlashcardReadRepository::class,
            'Flashcard\Application\Repository\ISessionReadRepository' => \Flashcard\Infrastructure\Repositories\Postgres\SessionReadRepository::class,
            'Flashcard\Application\Repository\ISessionRepository' => \Flashcard\Infrastructure\Repositories\Postgres\SessionRepository::class,
            'Flashcard\Application\Repository\ISmTwoFlashcardRepository' => \Flashcard\Infrastructure\Repositories\Postgres\SmTwoFlashcardRepository::class,
            'Flashcard\Application\Services\AiGenerators\IFlashcardGenerator' => \Flashcard\Application\Services\AiGenerators\GeminiGenerator::class,
            'Flashcard\Application\Services\IFlashcardSelector' => \Flashcard\Application\Services\SmTwo\SmTwoFlashcardSelector::class,
            'Flashcard\Application\Services\IRepetitionAlgorithm' => \Flashcard\Application\Services\SmTwo\SmTwoRepetitionAlgorithm::class,
            ...
            'Shared\Database\ITransactionManager' => \Shared\Database\LaravelTransactionManager::class,
            'Shared\Flashcard\IFlashcardAdminFacade' => \Flashcard\Application\Facades\FlashcardAdminFacade::class,
            'Shared\Flashcard\IFlashcardFacade' => \Flashcard\Application\Facades\FlashcardFacade::class,
            'Shared\Integrations\Gemini\IGeminiApiClient' => \Integrations\Gemini\GeminiApiClient::class,
            'Shared\User\IUserFacade' => \User\Application\Facades\UserFacade::class,
            'Shared\Utils\Config\IConfig' => \Shared\Utils\Config\Config::class,
            'Shared\Utils\Container\IContainer' => \Shared\Utils\Container\Container::class,
            'Shared\Utils\Hash\IHash' => \Shared\Utils\Hash\Hash::class,
            'Shared\Utils\Storage\IStorage' => \Shared\Utils\Storage\Storage::class,
            'Shared\Utils\Str\IStr' => \Shared\Utils\Str\Str::class,
            ...
            'User\Application\Repositories\IReportRepository' => \User\Infrastructure\Repositories\ReportRepository::class,
            'User\Application\Repositories\ITokenRepository' => \User\Infrastructure\Repositories\TokenRepository::class,
            'User\Application\Repositories\IUserRepository' => \User\Infrastructure\Repositories\UserRepository::class,
            'User\Domain\Contracts\IOAuthLogin' => \User\Infrastructure\OAuth\OAuthLogin::class,
